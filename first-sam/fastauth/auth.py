...
def check_username_password(user: schemas.UserAuthenticate):
    db_user_info: models.UserInfo = crud.get_user_by_username(username=user.username)
    db_pass = db_user_info[2].encode('utf8')
